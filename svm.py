...
#
    ...
    svm_cv_10_fold_result =pd.DataFrame( [cv_10_fold_auc, cv_10_fold_acc, cv_10_fold_bacc, cv_10_fold_recall, cv_10_fold_sp,
    ...
    svm_cv_10_fold_result_all.append(svm_cv_10_fold_result)
    svm_cv = pd.DataFrame([cv_result], index=[index1], columns=columns)
    svm_test = pd.DataFrame([test_result], index=[index2], columns=columns)
    result_cv.append(svm_cv)
    result_test.append(svm_test)
...
result_all_10_fold_result = pd.concat(svm_cv_10_fold_result_all,axis=0)
result_all_test_pred = pd.concat(test_pred_all,axis=1)
result_all_test_prob  =pd.concat(test_prob_all,axis=1)
result_all_cv.to_csv("svm_result/" + 'svm_result_cv.csv')
result_all_test.to_csv("svm_result/" + 'svm_result_test.csv')
result_all_param.to_csv("svm_result/" + 'svm_result_param.csv')
result_all_10_fold_result.to_csv("svm_result/"+'svm_cv_10_fold_result.csv')
result_all_test_pred.to_csv("svm_result/" + 'svm_result_test_pred.csv',index=None)
result_all_test_prob.to_csv("svm_result/" + 'svm_result_test_prob.csv',index=None)
